	...
	<section id="wrap">
		...
		<section id="sub_visual">
			<div class="bg_w">
				...
				<div class="bg" style="background-image: url(&quot;/static/portal/img/common/subvisual-common.jpg&quot;); transform: translate(-19.9517px, 9.99339px) scale(1.1);"></div>
		...
		<div id="cont">
					...
					<form name="board" id="board" method="post" action="/portal/myPage/acntMng/update.do">
						...
						<article class="member_join inner">
										...
										<div class="cont">
											<div class="birth_w clearfix">
												...
												<ul class="clearfix birth">
													<li><label for="birthdayYear" class="hide">연도 선택</label> <select name="birthdayYear" id="birthdayYear">
													...
													<li><label for="birthdayMonth" class="hide">월 선택</label> <select name="birthdayMonth" id="birthdayMonth">
													...
													<li><label for="birthdayDay" class="hide">일 선택</label> <select name="birthdayDay" id="birthdayDay">
												...
												</ul> <input type="hidden" name="birthDay" id="birthDay" value="19901111"> <input type="hidden" name="birthMonth" id="birthMonth" value="1111">
									...
									<li class="item"><strong class="t">주소 <span class="color-purple">*</span></strong>
										<div class="cont">
											<ul class="add">
												...
												<li class="clearfix a2"><span class="l"> <label for="memberAddr1" class="hide">주소</label> <input type="text" name="memberAddr1" id="memberAddr1" value="서울특별시 동작구 노량진로8길 55, 712호(노량진동, 더 클래식 동작)" readonly="">
												</span> <span class="r"> <label for="memberAddr2" class="hide">나머지 주소</label> <input type="text" name="memberAddr2" id="memberAddr2" value="712호" class="long">
												</span></li>
											</ul>
										</div></li>
									<li class="item"><strong class="t">이메일 <span class="color-purple">*</span></strong>
										<div class="cont">
											<ul class="email clearfix">
												...
												<li class="e3"><label for="email3" class="hide">이메일 주소 선택</label> <select name="emailDomain" id="emailDomain">
												...
												</select> <input type="hidden" name="memberEmail" id="memberEmail" value="you_yearning@hanmail.net"> <script>
													$("#emailDomain")
															.change(
																	function() {
																		if ($(
										...
										<div class="cont">
											<div class="tel_w">
												...
												<ul class="clearfix tel">
													<li><label for="memberCel1" class="hide">휴대폰 앞</label> <select name="memberCel1" id="memberCel1">
							...
							<div style="display: none;">
								<ul>
									<li><label for="cbdYear" class="hide">생년</label> <select name="cbdYear" id="cbdYear">
									...
									<li><label for="cbdDay" class="hide">일 선택</label> <select name="cbdDay" id="cbdDay">
									...
									<li class="item"><strong class="t">결혼기념일 </strong>
										<div class="cont">
											<div class="birth_w clearfix">
												...
												<ul class="clearfix birth">
													<li><label for="weddingDate1" class="hide">생년</label> <select name="weddingDate1" id="weddingDate1">
												...
												</ul> <input type="hidden" name="weddingDate" id="weddingDate" value="20220101">
											</div>
										</div></li>
									...
									<li class="item" id="childInfo" style="display: none;"><strong class="t">자녀생년월일 </strong>
										<div class="cont kids">
											...
											<div class="birth_w clearfix childItem" style="display: none;">
												<span>자녀 2</span>
												<ul class="clearfix birth">
													<li><label for="cbdYear2" class="hide">생년</label> <select name="cbdYear2" id="cbdYear2">
															<option value="">선택</option>
													...
													<li><label for="cbdMonth2" class="hide">월 선택</label> <select name="cbdMonth2" id="cbdMonth2">
															<option value="">선택</option>
													...
													<li><label for="cbdDay2" class="hide">일 선택</label> <select name="cbdDay2" id="cbdDay2">
															<option value="">선택</option>
											...
											<div class="birth_w clearfix childItem" style="display: none;">
												<span>자녀 3</span>
												<ul class="clearfix birth">
													<li><label for="cbdYear3" class="hide">생년</label> <select name="cbdYear3" id="cbdYear3">
															<option value="">선택</option>
													...
													<li><label for="cbdMonth3" class="hide">월 선택</label> <select name="cbdMonth3" id="cbdMonth3">
															<option value="">선택</option>
													...
													<li><label for="cbdDay3" class="hide">일 선택</label> <select name="cbdDay3" id="cbdDay3">
															<option value="">선택</option>
											...
											<div class="birth_w clearfix childItem" style="display: none;">
												<span>자녀 4</span>
												<ul class="clearfix birth">
													<li><label for="cbdYear4" class="hide">생년</label> <select name="cbdYear4" id="cbdYear4">
															<option value="">선택</option>
													...
													<li><label for="cbdMonth4" class="hide">월 선택</label> <select name="cbdMonth4" id="cbdMonth4">
															<option value="">선택</option>
													...
													<li><label for="cbdDay4" class="hide">일 선택</label> <select name="cbdDay4" id="cbdDay4">
															<option value="">선택</option>
			...
			-->
					...
					<form name="form_chk" method="post">
						...
						<!-- 필수 데이타로, 누락하시면 안됩니다. -->
						<input type="hidden" name="EncodeData" value="">
