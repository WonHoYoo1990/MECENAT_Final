...
<body class="hide-focus-ring">
	<section id="wrap">
		...
		<section id="sub_visual">
			<div class="bg_w">
				<div class="bg" style="background-image: url(&quot;/static/portal/img/common/subvisual-200043.jpg&quot;); transform: translate(-19.9989px, 10px) scale(1.1);"></div>
			</div>
			<h2 class="sub-t">
				...
				<div class="sub_page">
					<article class="ticket_com inner">
						<ul>
							<li class="group">
								<div class="tit">
									인터넷 예매 ㅇㅇㅇㅇ<span>인터넷 예매는 PC 홈페이지 및 모바일웹에서 예매가 가능합니다. </span>
								</div>
								<div class="cont">
									<dl class="t1">
										<dt>* 예매 시간</dt>
										...
										<dt>* 결제방법</dt>
										<dd>
											<strong class="t"> 신용카드 결제</strong> 카드결제를 하시면 바로 결제가 완료됩니다.
											<div class="sect">
												<strong class="t"> 가상계좌 결제</strong>
												<ol class="bul-decimal">
													<li>가상계좌는 해당 공연일로부터 3일 전까지 전화나 인터넷으로 예매 할 수 있습니다.</li>
													<li>가상계좌 결제 시, 예매완료 후 받으시는 가상계좌번호로 입금하시기 바랍니다.<br> (가상계좌번호는 입장권 결제마다 개별적으로 부여되는 번호입니다. 입금처리가 되면 실시간으로 결제처리가 되기 때문에 입금 확인하실 필요가 없습니다.)
													</li>
													<li>가상계좌번호는 부여 받은 후&nbsp;공연일 4일 전 예매일 기준 다음날 오후 11시 59분 이전까지, 공연일 3일 전 기준 예매 당일 오후 11시 59분 이전까지 유효합니다.&nbsp; 그 이후에는 자동 소멸되기 때문에 입금이 되지 않습니다.</li>
												</ol>
											</div>
										</dd>
									</dl>
							...
							<li class="group">
								...
								<div class="cont">
									<dl class="t1">
										<dt>* 예매 시간</dt>
										<dd>
											09:00 ~ 20:00 (연중무휴) <span class="color-purple">*연중무휴 , 공연 2시간전까지 가능, 일부 공연에 한하여 전화 예매가 불가능 할 수 있습니다. </span>
										</dd>
										<dt>* 예매 방법</dt>
							...
							<li class="group">
								...
								<div class="cont">
									<dl class="t1">
										<dt>* 예매 시간</dt>
										<dd>
											10:00 ~ 20:00 (연중무휴) <span class="color-purple">*점심시간: 13시~14시</span>
										</dd>
										<dt>* 예매 방법</dt>
										<dd>
											서비스 플라자를 방문하시면 바로 예매하실 수 있습니다. 서비스 플라자 위치는 세종문화회관 중앙계단 위에 위치하고 있습니다.
							...
							<li class="group">
								...
								<div class="cont">
									<ul class="bul-dot t2">
										<li>장애인 복지카드와 국가유공자카드를 소지하고 계신 분들의 경우&nbsp;<strong class="color-navy">50% 할인혜택</strong>을 제공하고 있습니다.
										...
										<li>장애인 · 국가유공자 우대할인 예매는 인터넷 예매와 현장예매, 전화예매가 가능합니다.(일부 공연의 경우, 전화예매로만 운영될 수 있습니다.)</li>
										<li>인터넷 예매와 현장예매, 전화예매 모두 입장권 수령(발권) 시 장애인 복지카드와 국가유공자 카드를 반드시 제시하셔야 합니다.<br> (미증빙시 할인을 받으실 수 없으며, 선 할인 받은 금액이 있으면 차액을 지불하셔야 합니다.)
									</li>
										...
										<li class="rel"><strong class="color-navy">전화 예매&nbsp;</strong> 세종문화회관 고객센터에서 전화예매 시 장애인, 국가유공자임을 말씀해 주시고, 현장에서 장애인 복지카드, 국가유공자 카드 지참하시어 증빙 후 입장권을 수령해 주시기 바랍니다.</li>
									</ul>
								</div>
						</li>
						</ul>
