		    ...
		    <div class="row">
		        <div class="col-lg-12 text-center">
		            <div class="normal__breadcrumb__text" style="background-image: url('./resources/img/reserve/reserve_top.jpg'); background-size:cover; height: 300px; padding-top: 8%;" >
		                ...
		                <p style="color:black; font-weight:bold;">Before apply document,<br> check event date and time</p>
		            </div>
		        </div>
		    </div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login__form">
						...
						<form action="application2.rv" method="post">						
							<!-- 확인*********************************************************************** -->
							<c:forEach var="i" items="${arr }">
							<div class="input__item"><!-- 해당공연일 공연시작시간 -->			
								<input type="text" id="startTimes" name="startTimes"  placeholder="아래 공연일을 확인하세요" required/>	
								<label for="startTime"><span class="icon_lock"></span>${i} 해당 날짜의 공연 시작시간을 입력하세요 ex)18:00(24시간 기준)</label>
							</div>
							</c:forEach>
							<!-- 확인*********************************************************************** -->
